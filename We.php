    ...
    <header class="header">
        ...
        <nav class="menu">
            <ul class="navegacion">
                ...
                <li><a href="We.php" class="active">Nosotros</a></li>
...
<section class="platos equipo">
    <article class="miembro">
        <img src="" alt="">
        <h2>Valentina Ferreyra</h2>
        <p>Fundadora y Gerente General. Apasionada por crear experiencias deliciosas y auténticas para nuestros clientes.</p>
    </article>

    <article class="miembro">
        <img src="" alt="">
        <h2>Agustin Sule</h2>
        <p>Asistente de Documentación. Responsable de organizar y preparar todos los documentos importantes del proyecto.</p>
    </article>

    <article class="miembro">
        <img src="" alt="">
        <h2>Martina Ferreyra</h2>
        <p>Gerente de Marketing y Comunicación. Encargada de conectar con nuestra comunidad y promocionar la marca.</p>
    </article>
</section>
...
// Cargar carrito persistente sin filtrar
