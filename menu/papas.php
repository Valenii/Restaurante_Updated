...
// Traer todos los productos que pertenezcan a la categoría 'Papas Fritas'
$sql = "SELECT p.id, p.nombre, p.precio, p.stock, p.imagen
        FROM productos p
        INNER JOIN categorias c ON p.categoria_id = c.id
        WHERE c.nombre = 'Papas Fritas'";
...
if ($resultado && $resultado->num_rows > 0) {
    ...
    die("⚠️ No se encontraron productos en la categoría 'Papas Fritas'.");
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <style>
    ...
    .btn-agregar { background-color:orange; color:white; border:none; border-radius:50%; width:35px; height:35px; font-size:20px; cursor:pointer; transition:0.3s; }
    .btn-agregar:hover { background-color:darkorange; transform:scale(1.1); }
  </style>
</head>
<body>
  ...
  <main class="comida">
    ...
    <div class="platos">
      ...
      <article class="plato">
        ...
        <p><?php echo htmlspecialchars($p['nombre']); ?>, ¡perfecta para acompañar tu comida!</p>
